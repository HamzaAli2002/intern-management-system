    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: const [
            Tab(icon: Icon(Icons.people_rounded, size: 18), text: 'Interns'),
            Tab(icon: Icon(Icons.task_rounded, size: 18), text: 'Tasks'),
            Tab(icon: Icon(Icons.rate_review_rounded, size: 18), text: 'Review'),
          ],
        ),
      ),
      body: Column(
            ...
            if (filtered.isEmpty)
              ...
              Expanded(
                child: ListView.separated(
                  ...
                  itemBuilder: (ctx, i) => InternListCard(
                    intern: filtered[i],
                    onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (_) =>
                              InternProfileScreen(intern: filtered[i])),
                    ),
                  ),
                ),
              ),
              ...
              child: ListView.separated(
                ...
                itemBuilder: (ctx, i) => _ReviewCard(
                  ...
                  onTap: () => Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (_) =>
                            TaskReviewScreen(taskId: tasks[i].id)),
                  ),
                ),
              ),
            ),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '${task.assignedToName}  •  ${task.attachments.length} file(s)',
                    style: const TextStyle(
