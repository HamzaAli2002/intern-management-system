...
class InternProfileScreen extends StatelessWidget {
          ...
          SliverAppBar(
                    ...
                    children: [
                      CircleAvatar(
                        ...
                        child: Text(
                          ...
                          style: const TextStyle(color: AppTheme.accent, fontSize: 24, fontWeight: FontWeight.w700),
                        ),
                      ),
            ...
            actions: [
              PopupMenuButton<String>(
                ...
                itemBuilder: (_) => [
                  const PopupMenuItem(value: 'active', child: Row(children: [
                    Icon(Icons.check_circle_outline, color: Colors.green, size: 18),
                    SizedBox(width: 8), Text('Set Active')])),
                  const PopupMenuItem(value: 'completed', child: Row(children: [
                    Icon(Icons.school_outlined, color: Colors.blue, size: 18),
                    SizedBox(width: 8), Text('Set Completed')])),
                  const PopupMenuItem(value: 'inactive', child: Row(children: [
                    Icon(Icons.pause_circle_outline, color: Colors.orange, size: 18),
                    SizedBox(width: 8), Text('Set Inactive')])),
                  const PopupMenuDivider(),
                  const PopupMenuItem(value: 'delete', child: Row(children: [
                    Icon(Icons.delete_outline, color: Colors.red, size: 18),
                    SizedBox(width: 8), Text('Delete Intern', style: TextStyle(color: Colors.red))])),
                ],
              ),
            ],
          ),
              ...
              child: ConstrainedBox(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      // Progress
                      _card(title: 'Progress', child: Row(children: [
                        ProgressRing(
                          progress: intern.progressPercent,
                          size: 68, color: AppTheme.accent,
                      ...
                      // Profile info
                      _card(title: 'Profile Information', child: Column(children: [
                ...
                delegate: SliverChildBuilderDelegate(
                  (_, i) => Center(
                    child: ConstrainedBox(
                      constraints: const BoxConstraints(maxWidth: R.maxW),
                      child: Padding(
                        padding: EdgeInsets.fromLTRB(16, 0, 16, i == tasks.length - 1 ? 100 : 10),
  ...
  Widget _card({required String title, required Widget child}) => Container(
    ...
    decoration: BoxDecoration(
      ...
      boxShadow: [BoxShadow(color: AppTheme.primary.withOpacity(0.04), blurRadius: 8, offset: const Offset(0, 3))],
    ),
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Text(title, style: const TextStyle(fontSize: 11, fontWeight: FontWeight.w600,
          color: AppTheme.textLight, letterSpacing: 0.4)),
  ...
  Widget _infoRow(IconData icon, String label, String value, {Color? color}) => Row(children: [
    ...
    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Text(value, style: TextStyle(color: color ?? AppTheme.textDark, fontWeight: FontWeight.w500, fontSize: 13)),
    ])),
  ]);
