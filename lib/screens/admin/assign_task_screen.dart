  ...
  Future<void> _assignTask() async {
    ...
    if (_selectedInternUid == null) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
          content: Text('Please select an intern'),
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    prefixIcon:
                        Icon(Icons.title_rounded, color: AppTheme.accent),
                  ),
                  validator: (v) =>
                      v?.isEmpty == true ? 'Task title is required' : null,
                ),
                SizedBox(height: gapSize),
                TextFormField(
                    ...
                    return DropdownButtonFormField<String>(
                      ...
                      items: interns
                          .map((i) => DropdownMenuItem(
                                value: i.uid,
                                child: Text('${i.name} — ${i.department}'),
                              ))
                          .toList(),
                      onChanged: (uid) {
                      ...
                      validator: (v) =>
                          v == null ? 'Please select an intern' : null,
                    );
                  },
                ),
