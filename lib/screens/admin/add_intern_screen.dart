...
class _AddInternScreenState extends State<AddInternScreen> {
  ...
  final _departments = ['Flutter','React','Python','AI/ML','Backend','UI/UX','Full Stack'];

  @override
  void dispose() {
    _nameCtrl.dispose(); _emailCtrl.dispose(); _passCtrl.dispose();
    _phoneCtrl.dispose(); _batchCtrl.dispose();
    super.dispose();
  }
  ...
  Future<void> _register() async {
    ...
    final result = await _auth.registerIntern(
      ...
      department: _selectedDept, batchNo: _batchCtrl.text.trim(),
      ...
      await showDialog(
        ...
        builder: (_) => AlertDialog(
          ...
          title: const Row(children: [
            Icon(Icons.check_circle_rounded, color: AppTheme.accent, size: 26),
            SizedBox(width: 10),
  ...
  Widget _credRow(String label, String value) => Row(
    ...
    children: [
      ...
      Expanded(child: Text(value, style: const TextStyle(color: AppTheme.textDark, fontSize: 13, fontWeight: FontWeight.w600))),
    ],
  );
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 14),
                    _field(controller: _batchCtrl, label: 'Batch No. (e.g. Batch-12)', icon: Icons.group_outlined,
                        validator: (v) => v?.isEmpty == true ? 'Batch number is required' : null),
                    const SizedBox(height: 24),
                    ...
                    Container(
                      ...
                      child: const Text('🔐 Share these credentials with the intern so they can log in.',
